                        ...
                        @foreach ($tim as $tm)
                            <tr style="vertical-align: middle; font-size: 17px;" idTm={{ $tm->id_tim }}>
                                ...
                                <td class="col-1" style="text-align: center">
                                    @if ($tm->foto_tim)
                                        <img src="{{ asset('storage/' . $tm->foto_tim) }}" alt="Foto Profil"
                                            style="width: 150px; height: 90px;" class="rounded">
                                    @else
                                        ...
                                        <div class="dropdown dropend"
                                            ...
                                            <div class="dropdown-menu" style="width: 200px;"
                                                ...
                                                <a class="dropdown-item editBtn" data-bs-toggle="modal"
                                                    data-bs-target="#edit-modal-{{ $tm->id_tim }}" style="cursor: pointer"
                                                    idTM={{ $tm->id_tim }}>
                                                ...
                                                <a class="dropdown-item hapusBtn" idTM={{ $tm->id_tim }}
                                            ...
                                            <form id="edit-tm-form-{{ $tm->id_tim }}">
                                                <div class="form-group">
                                                    ...
                                                    <input placeholder="example" type="text" class="form-control mb-3"
                                                        name="nama_tim" value="{{ $tm->nama_tim }}" required />
                                                    @csrf
                                                </div>
                                                ...
                                                <select name="nik_pelatih" id="pilihPelatih" class="form-select mb-3">
                                                    ...
                                                    @foreach ($pelatih as $pl)
                                                        <option value="{{ $pl->nik_pelatih }}"
                                                            {{ $tm->nik_pelatih === $pl->nik_pelatih ? 'selected' : '' }}>
                                                            {{ $pl->nama_pelatih }}
                                                        </option>
                                                    @endforeach
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea required name="deskripsi_tim" id="" class="form-control" rows="5" placeholder="Deskripsi Tim"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 mt-3 align-items-center">
                                                        ...
                                                        <input type="file" name="foto_tim" id="fileUpload"
                ...
                if (result.isConfirmed) {
                    ...
                    axios.delete('/tim/hapus/' + idTM).then(function(response) {
                        ...
                        if (response.data.success) {
                            swal.fire('Selamat!', 'Tim berhasil dihapus.', 'success').then(
                            function() {
                                //Refresh Halaman
                                location.reload();
                            });
