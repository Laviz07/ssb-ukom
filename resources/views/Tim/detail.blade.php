                        ...
                        <div class="ms-4">
                            <div class="row">
                                ...
                                <span class="mt-1 text-capitalize "
                                    style="font-size: 18px;">{{ $tim->pelatih->nama_pelatih }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td style="text-align: center">
                                        <div class="dropdown dropend"
                                            ...
                                            <div class="dropdown-menu" style="width: 230px;"
                                                ...
                                                <a class="dropdown-item hapusBtn" idTM="{{ $pm->nisn_pemain }}"
                                                    data-nisn-pemain="{{ $pm->nisn_pemain }}" style="cursor: pointer">
                                                    <i class="bi bi-trash"
                                                        style="font-size: 20px; vertical-align: middle;"></i>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary addBtn" form="add-pm-form">
                            Tambah
                        </button>
                    </div>
                </div>
        ...
        $('.hapusBtn').on('click', function(e) {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    axios.delete(`/tim/hapus/anggota/${idTM}`, {
                            data: {
                                nisn_pemain: nisnPemain
                            }
                        })
