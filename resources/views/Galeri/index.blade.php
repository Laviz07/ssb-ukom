                                            ...
                                            <div class="dropdown-menu" style="width: 200px;"
                                                ...
                                                @if (Auth::user()['role'] == 'admin')
                                                    <a class="dropdown-item editBtn" data-bs-toggle="modal"
                                                        data-bs-target="#edit-modal-{{ $gl->id_galeri }}"
                                                    ...
                                                    <a class="dropdown-item hapusBtn" idGL={{ $gl->id_galeri }}
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="edit-gl-form-{{ $gl->id_galeri }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                                <label>Keterangan Gambar</label>
                                                <textarea name="keterangan_foto" id="" rows="2" required class="form-control" style="resize: none">{{ $gl->keterangan_foto }}
                                    </textarea>
                                            </div>
                    ...
                    axios.delete('/galeri/hapus/' + idGL)
                        .then(function(response) {
                            ...
                            if (response.data.success) {
                                swal.fire('Selamat!', 'Galeri berhasil dihapus.', 'success').then(
                                    function() {
                                        // Refresh Halaman
                                        location.reload();
                                    });
                            } else {
                                swal.fire('Waduh!', 'Galeri gagal dihapus.', 'warning').then(
                                    function() {
                                        // Refresh Halaman
                                        location.reload();
                                    });
