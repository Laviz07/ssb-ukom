...
@section('content')
                            ...
                            <tr style="vertical-align: middle; font-size: 17px;" idKG={{ $kg->id_kegiatan }}>
                                ...
                                <td class="col-3" style="text-align: center">
                                        ...
                                        <div class="dropdown dropend"
                                            ...
                                            <div class="dropdown-menu" style="width: 200px;"
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ url('jadwal', ['kegiatan', 'detail', $kg->id_kegiatan]) }}">
                                                    <i class="bi bi-eye"
                                                ...
                                                <a class="dropdown-item editBtn" data-bs-toggle="modal"
                                                    data-bs-target="#edit-modal-{{ $kg->id_kegiatan }}"
                                                ...
                                                <a class="dropdown-item hapusBtn" idKG={{ $kg->id_kegiatan }}
                                    ...
                                    @if (Auth::user()['role'] == 'pemain')
                                        <a href="{{ url('jadwal', ['kegiatan', 'detail', $kg->id_kegiatan]) }}"
                                            ...
                                            <form id="edit-kg-form-{{ $kg->id_kegiatan }}" method="POST">
                                                <div class="form-group">
                                                    ...
                                                    <input placeholder="example" type="text" class="form-control mb-3"
                                                        name="nama_kegiatan" value="{{ $kg->nama_kegiatan }}" required />
                                                    @csrf
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="time" class="form-control" required
                                                                name="jam_mulai" value="{{ $kg->jam_mulai }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="time" class="form-control" required
                                                                name="jam_selesai" value="{{ $kg->jam_selesai }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mt-3">
                                                    ...
                                                    <select name="nik_pelatih" id="pilihPelatih" class="form-select mb-3">
                                                        ...
                                                        @foreach ($pelatih as $pl)
                                                            <option value="{{ $pl->nik_pelatih }}"
                                                                {{ $kg->nik_pelatih === $pl->nik_pelatih ? 'selected' : '' }}>
                                                                {{ $pl->nama_pelatih }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group mt-3">
                                                    ...
                                                    <select name="tipe_kegiatan" id="pilihPelatih" class="form-select mb-3">
                                                        <option value="" disabled selected>Pilih Tipe Kegiatan
                                                        </option>
                                                        <option value="latihan"
                                                            {{ $kg->tipe_kegiatan === 'latihan' ? 'selected' : '' }}>
                                                            Latihan
                                                        </option>
                                                        <option value="pertandingan"
                                                            {{ $kg->tipe_kegiatan === 'pertandingan' ? 'selected' : '' }}>
                                                            Pertandingan
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea required name="detail_kegiatan" id="" class="form-control" rows="5"
                                                        placeholder="Detail Kegiatan" style="resize: none">{{ $kg->detail_kegiatan }}
                                                </textarea>
                                                </div>
    ...
    <div class="col d-flex justify-content-end mb-2 mt-3">
        @if ((Auth::check() && Auth::user()->role == 'admin') || Auth::user()->role == 'pelatih')
            <a href="{{ url('jadwal', [$jadwal->id_jadwal, 'kegiatan', 'tambah']) }}"
                class="position-fixed z-10 bottom-0 end-0">
