        ...
        <div class="row">
            ...
            <div class="col-md-12 mt-4">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form action="{{ url('jadwal', [$jadwal->id_jadwal, 'kegiatan', 'tambah']) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mt-2">
                                                ...
                                                <select name="nik_pelatih" required id="pilihPelatih"
                                                    class="form-select mb-3">
                                                    <option value="" selected disabled>Pilih Pelatih</option>
                                                    @foreach ($pelatih as $pl)
                                                        <option value="{{ $pl->nik_pelatih }}">{{ $pl->nama_pelatih }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea required name="detail_kegiatan"class="form-control" rows="3" placeholder="Detail Kegiatan"
