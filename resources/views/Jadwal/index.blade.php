        ...
        <div class=" mt-3">
                ...
                @foreach ($jadwal as $jw)
                        ...
                        <tr style="vertical-align: middle; font-size: 17px;" idJw={{$jw->id_jadwal}}>
                            ...
                            <td class="col-3" style="text-align: center"> {{$jw->id_jadwal}} </td>
                            <td style="text-align: center">
                                ...
                                <div class="dropdown dropend" style="display: inline-block; vertical-align: middle;">
                                    ...
                                    <h6 class="dropdown-header">Apa Yang Akan Anda Lakukan?</h6>
                                       <a class="dropdown-item" href="{{ url('jadwal', ['detail', $jw->id_tim]) }}"> 
                                        <i class="bi bi-eye"  style="font-size: 20px; vertical-align: middle; "></i> 
                                        <strong class="ms-1">Lihat Detail Tim</strong> 
                                       </a>

                                    @if (Auth::user()['role']=='admin')
                                        <a class="dropdown-item editBtn" data-bs-toggle="modal" data-bs-target="#edit-modal-{{$jw->id_tim}}" 
                                            style="cursor: pointer" idJW = {{$jw->id_tim}} > 
                                            <i class="bi bi-pencil"  style="font-size: 20px; vertical-align: middle; "></i> 
                                            <strong class="ms-1" >Edit Data Tim</strong> 
                                        </a>

                                        <a class="dropdown-item hapusBtn" idJW={{$jw->id_tim}} style="cursor: pointer"> 
