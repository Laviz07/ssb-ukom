...
@section('content')
                                        ...
                                        <div class="dropdown dropend"
                                            ...
                                            <div class="dropdown-menu" style="width: 200px;"
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ url('jadwal', ['kegiatan', $jw->id_jadwal]) }}">
                                                    <i class="bi bi-calendar4-event"
                                                ...
                                                <a class="dropdown-item editBtn" data-bs-toggle="modal"
                                                    data-bs-target="#edit-modal-{{ $jw->id_jadwal }}"
                                                ...
                                                <a class="dropdown-item hapusBtn" idJW={{ $jw->id_jadwal }}
                                            ...
                                            <form id="edit-jw-form-{{ $jw->id_jadwal }}">
                                                <div class="form-group">
                                                    ...
                                                    <input placeholder="example" type="text" class="form-control mb-3"
                                                        name="judul_kegiatan" value="{{ $jw->judul_kegiatan }}" required />
                                                    @csrf
                                                </div>
    ...
    <div class="col d-flex justify-content-end mb-2 mt-3">
        @if ((Auth::check() && Auth::user()->role == 'admin') || Auth::user()->role == 'pelatih')
            ...
            <a href="{{ url('jadwal', ['cetak']) }}" target="blank" class="position-fixed z-10  end-0 "
                style="bottom: 50px">
