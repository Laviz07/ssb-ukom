                ...
                <div class="row p-4 d-flex flex-column align-items-center justify-content-center">
                    <div class="text-center">
                        <img src="{{ asset('storage/' . $user->pemain->user->foto_profil) }}"
                            alt="{{ $user->pemain->nama_pemain }}" class="rounded-circle" style="width: 170px; height: 170px;">
                    </div>
                    <div class="mt-4 ">
                        <div class="row">
                        ...
                        <div class="row mt-2 ">
                            ...
                            <div class="dropdown dropend" style="display: inline-block; vertical-align: middle;">
                                <button class="btn btn-primary mt-4" style="width: 100%" id="navbarDropdownMenuLink"
                                ...
                                <div class="dropdown-menu" style="width: 200px;" aria-labelledby="navbarDropdownMenuLink">
                                    ...
                                    <a class="dropdown-item editBtn" data-bs-toggle="modal"
                                        data-bs-target="#editUsername-modal-{{ $user->id_user }}"
                                    ...
                                    <a class="dropdown-item editBtn" data-bs-toggle="modal"
                                        data-bs-target="#editPassword-modal-{{ $user->id_user }}"
                                        idUser={{ $user->id_user }} style="cursor: pointer">
                                    ...
                                    <a class="dropdown-item editBtn" data-bs-toggle="modal"
                                        data-bs-target="#editFotoProfil-modal-{{ $user->id_user }}"
                                        idUser={{ $user->id_user }} style="cursor: pointer">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit-pm-form-{{ $user->pemain->nisn_pemain }}">
                        ...
                        <div class="form-group">
                            <label>Alamat:</label>
                            <textarea required name="alamat" id="" class="form-control" rows="3" placeholder="Alamat"
                        ...
                        <div class="form-group mt-2">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="number" class="form-control" placeholder="example" name="no_telp"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_pemain" id="" required placeholder="deskripsi diri anda" class="form-control"
                                rows="5" placeholder="Deskripsi Diri" style="resize: none">{{ $user->pemain->deskripsi_pemain }}
                    </textarea>
                        </div>
                    </form>
                </div>
...
<div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary edit-btn" form="edit-un-form-{{ $user->id_user }}">
                        Edit
                    </button>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary edit-btn" form="edit-pw-form-{{ $user->id_user }}">
                        Edit
                    </button>
                </div>
            </div>
    ...
    {{-- - EDIT FOTO PROFIL --}}
    <div class="modal fade" id="editFotoProfil-modal-{{ $user->id_user }}" tabindex="-1"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form id="edit-fp-form-{{ $user->id_user }}" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="col-md-4 mt-0 align-items-center">
                            ...
                            <img src="#" id="imagePreview" alt="preview"
                                style="width: 250px; height: 250px; display: none" class="mt-2 rounded ">
                            @csrf
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary edit-btn"
                            form="edit-fp-form-{{ $user->id_user }}">Edit</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        $('.editBtn').on('click', function(e) {
            ...
            $(`#edit-pm-form-${idPM}`).on('submit', function(e) {
                ...
                axios.post(`/profil/pemain/edit/${idPM}`, data)
                    ...
                    .catch(() => {
                        swal.fire('Pemain gagal diedit!', 'Pastikan mengisi data seluruhnya.',
                            'warning');
                    })
            })
        })
