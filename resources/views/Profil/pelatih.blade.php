            ...
            <div class="col-md-8 card" style="width: 65%">
                <div class="row p-3">
                    ...
                    <div class="row mt-3">
                        ...
                        <span style="font-size: 17px; line-height: normal "> {{ $user->pelatih->deskripsi_pelatih }}
                        </span>
                    </div>
                ...
                <div class="modal-body">
                    <form id="edit-pl-form-{{ $user->pelatih->nik_pelatih }}">
                        <div class="form-group">
                            ...
                            <input placeholder="example" type="text" class="form-control mb-3" name="nama_pelatih"
                                value="{{ $user->pelatih->nama_pelatih }}" required />
                            @csrf
                        </div>
        ...
        $('.editBtn').on('click', function(e) {
            ...
            $(`#edit-pl-form-${idPL}`).on('submit', function(e) {
                ...
                axios.post(`/profil/pelatih/edit/${idPL}`, data)
                    ...
                    .catch(() => {
                        swal.fire('Pelatih gagal diedit!', 'Pastikan mengisi data seluruhnya.',
                            'warning');
                    })
            })
        })
