                                        ...
                                        <div class="ps-3" style="display: flex; align-items: center;">
                                            <div class="dropdown dropend" style="margin-right: 20px;">
                                                <i class="bi bi-three-dots-vertical"
                                                    style="font-size: 20px; cursor: pointer;" id="beritaDropdown"
                                                    data-bs-toggle='dropdown' data-bs-offset="-10,20">
                                                </i>
                                                <div class="dropdown-menu z-2" style="width: 200px;"
                                                    ...
                                                    <a class="dropdown-item editBtn" data-bs-toggle="modal"
                                                        data-bs-target="#edit-modal-{{ $br->id_berita }}"
                                                    ...
                                                    <a class="dropdown-item hapusBtn" idBR="{{ $br->id_berita }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered" style="max-width: 70%">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="edit-br-form-{{ $br->id_berita }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label>Judul Berita Baru</label>
                                            <textarea name="judul_berita" id="" rows="2" required class="form-control" style="resize: none">
                                                {{ $br->judul_berita }}
                                            </textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="isi_berita" id="" rows="10" required class="form-control" style="resize: none">
                                                {{ $br->isi_berita }}
                                            </textarea>
                                        </div>
                                        {{-- <input type="hidden" name="id_berita" value="{{$br->id_berita}}"> --}}
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mt-3 align-items-center">
                                                ...
                                                <input type="file" name="foto_berita" id="fileUpload"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary edit-btn"
                                        form="edit-br-form-{{ $br->id_berita }}">
                                        Edit
                                    </button>
                    ...
                    axios.delete('/berita/hapus/' + idBR)
                        .then(function(response) {
                            ...
                            if (response.data.success) {
                                swal.fire('Selamat!', 'Berita berhasil dihapus.', 'success').then(
                                    function() {
                                        // Refresh Halaman
                                        location.reload();
                                    });
                            } else {
                                swal.fire('Waduh!', 'Berita gagal dihapus.', 'warning').then(
                            function() {
                                    // Refresh Halaman
                                    location.reload();
                                });
