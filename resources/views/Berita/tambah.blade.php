                        ...
                        <form action="{{ url('berita', ['tambah']) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <textarea name="judul_berita" id="" rows="2" class="form-control" placeholder="Judul Berita"
                                        style="resize: none"></textarea>
                                </div>
                                <div class="form-group mt-2">
                                    <label for="">Isi Berita:</label>
                                    <textarea name="isi_berita" id="" rows="10" class="form-control" placeholder="Keterangan Berita"
                                        style=""></textarea>
                                </div>
                                <div class="row">
