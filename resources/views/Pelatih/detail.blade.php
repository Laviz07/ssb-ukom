    ...
    <div class="container mt-4 mb-4">
                    ...
                    <div class="mt-4 text-center">
                        <div>
                            <span class="text-capitalize"
                                style="font-weight: 800; font-size: 26px;">{{ $pelatih->nama_pelatih }}</span>
                        </div>
                        <div class="row">
                            <span>No. Telp:
                                <a href="https://wa.me/62{{ $pelatih->no_telp }}" target="blank"
        ...
        <div class="row mt-4 mb-4">
            @if ($pelatih->tim->count() > 0)
                    ...
                    <div class="col-lg-4 col-md-12 mb-4 mt-4 mb-lg-0">
                        <div class="col-md-3 card mt-4 align-items-center" style="width: 350px; ">
                            <a href="{{ url('tim', ['detail', $ptm->id_tim]) }}">
                                <img src="{{ asset('storage/' . $ptm->foto_tim) }}" alt="Stadion" width="320"
                                    height="200" class="rounded p-2 pt-4">
                            </a>
                            <div class="row p-3" ">
                ...
                @endforeach
            @else
                <span class="text-center text-capitalize mt-5 mb-5 "
                    style="font-size: 40px; font-weight: 700; color: #7c7c7c;">
