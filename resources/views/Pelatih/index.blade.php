...
@section('content')
                        ...
                        @foreach ($pelatih as $pl)
                            <tr style="vertical-align: middle; font-size: 17px;" idPl{{ $pl->nik_pelatih }}>
                                ...
                                <td style="text-align: center">
                                        ...
                                        <div class="dropdown dropend"
                                            ...
                                            <div class="dropdown-menu" style="width: 200px;"
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ url('pelatih', ['detail', $pl->nik_pelatih]) }}">
                                                    <i class="bi bi-eye"
                                                ...
                                                <a class="dropdown-item editBtn" data-bs-toggle="modal"
                                                    data-bs-target="#edit-modal-{{ $pl->nik_pelatih }}"
                                                ...
                                                <a class="dropdown-item hapusBtn" idPL={{ $pl->nik_pelatih }}
                                    ...
                                    @if (Auth::user()['role'] != 'admin')
                                        <a href="{{ url('pelatih', ['detail', $pl->nik_pelatih]) }}"
                                            ...
                                            <form id="edit-pl-form-{{ $pl->nik_pelatih }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input placeholder="example" type="text" class="form-control mb-3"
                                                        name="nama_pelatih" value="{{ $pl->nama_pelatih }}" required />
                                                    @csrf
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea required name="alamat" id="" class="form-control" rows="3" placeholder="Deskripsi Diri"
                                                        style="resize: none">{{ $pl->alamat }}</textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input placeholder="example" type="number" class="form-control mb-3"
                                                        name="no_telp" value="{{ $pl->no_telp }}" required />
                                                </div>

                                                <div class="form-group">
                                                    <label>Email:</label>
                                                    <input placeholder="example" type="email" class="form-control mb-3"
                                                        name="email" value="{{ $pl->email }}" required />
                                                </div>

                                                <div class="form-group">
                                                    <label>Deskripsi Diri:</label>
                                                    <textarea required name="deskripsi_pelatih" id="" class="form-control" rows="5"
                                                        placeholder="Deskripsi Diri" style="resize: none">
                                                        {{ $pl->deskripsi_pelatih }}
                                                    </textarea>
                                                </div>
                                            </form>
                                        </div>
    ...
    <div class="col d-flex justify-content-end mb-2 mt-3">
        ...
        @if ((Auth::check() && Auth::user()->role == 'admin') || Auth::user()->role == 'pelatih')
            <a href="{{ url('pelatih', ['cetak']) }}" target="blank" class="position-fixed z-10  end-0 "
                style="bottom: 50px">
                ...
                if (result.isConfirmed) {
                    ...
                    axios.delete('/pelatih/hapus/' + idPL).then(function(response) {
                        ...
                        if (response.data.success) {
                            swal.fire('Selamat!', 'Pelatih berhasil dihapus.', 'success').then(
                                function() {
                                    //Refresh Halaman
                                    location.reload();
                                });
                        } else {
                            swal.fire('Waduh!', 'Pelatih gagal dihapus.', 'warning').then(
                        function() {
                                //Refresh Halaman
                                location.reload();
                            });
