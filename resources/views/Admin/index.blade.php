                    ...
                    <tbody>
                        ...
                        @foreach ($admin as $ad)
                            <tr style="vertical-align: middle; font-size: 17px;" idAD{{ $ad->nik_admin }}>
                                ...
                                <td class="col-1" style="text-align: center">
                                    <a href="https://wa.me/62{{ $ad->no_telp }} " target="blank"
                                    ...
                                    <div class="dropdown dropend" style="display: inline-block; vertical-align: middle;">
                                        ...
                                        <div class="dropdown-menu" style="width: 200px;"
                                            ...
                                            <a class="dropdown-item editBtn" data-bs-toggle="modal"
                                                data-bs-target="#edit-modal-{{ $ad->nik_admin }}" style="cursor: pointer"
                                                idAD={{ $ad->nik_admin }}>
                                            ...
                                            <a class="dropdown-item hapusBtn" idAD={{ $ad->nik_admin }}
                                            ...
                                            <form id="edit-ad-form-{{ $ad->nik_admin }}">
                                                <div class="form-group">
                                                    ...
                                                    <input placeholder="example" type="text" class="form-control mb-3"
                                                        name="nama_admin" value="{{ $ad->nama_admin }}" required />
                                                    @csrf
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input placeholder="example" type="email" class="form-control mb-3"
                                                        name="email" value="{{ $ad->email }}" required />
                                                </div>
