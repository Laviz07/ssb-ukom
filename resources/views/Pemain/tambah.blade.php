        ...
        <div class="row">
            ...
            <div class="col-md-12 mt-4">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form action="{{ url('pemain', ['tambah']) }}" method="POST" id="tambah-pemain-form"
                            ...
                            <div class="row">
                                ...
                                @endauth --}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea required name="deskripsi_pemain" id="" class="form-control" rows="3"
                                            placeholder="Deskripsi Diri" style="resize: none"></textarea>
                                    </div>

                                    <div class="row">
                                        <div class="col-md-4 mt-3 align-items-center">
                                            <label for="fileUpload" class="">Upload Foto (masukkan frame 1:1)
                                                :</label>
                                            <input type="file" name="foto_profil" id="fileUpload"
