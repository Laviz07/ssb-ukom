...
<head>
    ...
    <link
        href="@import url('https://fonts.googleapis.com/css2?family=Outfit:wght@100;200;300;400;500;600;700;800;900&display=swap');"
        rel="stylesheet">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6 text-black">
                    ...
                    <div class="px-5 ms-xl-5">
                        <div class="d-flex"><i class="fas fa-crow fa-2x me-9 pt-5 mt-xl-4" style="color: #709085;"></i>
                            <img src="{{ asset('images/logo1.png') }}" alt="ssb logo" width="150" height="150"
                                style="margin: 15px">
                            <h3 class="display-8 fw-bold ls-tight h3 text-uppercase"
                                style="color: #003459; font-size:38px; margin-top: 45px">
                                <i>ONE</i><br>SOCCER
                            </h3>
                        </div>
                        ...
                        <form style="width: 32rem;" action="">
                            ...
                            <div class="form-outline mb-2" style="position: relative;">
                                ...
                                <input type="password" id="password" name="password" placeholder="Masukkan Password"
                                    class="form-control form-control-lg" style="width: 100%; padding-right: 30px;">
                            ...
                            <div class="pt-1 mb-4">
                                <button class="btn btn-info btn-lg btn-block" type="submit"
                                    style="background-color: #003459; color:aliceblue; width:100%">Login</button>
                            </div>
                            @csrf
                        </form>
                ...
                <div class="col-sm-6 px-0 d-none d-sm-block">
                    <img src="{{ asset('images/bg_ssb.png') }}" alt="bg logo" alt="Login image" class="w-100 vh-100"
    ...
    <script type="module">
        $('form').submit(async function(e) {
            ...
            try {
                ...
                swal.fire('Waduh!',
                    'Anda tidak bisa login, pastikan username dan password terisi dengan benar!', 'warning');
                console.error(error);
            }
        });
    </script>
