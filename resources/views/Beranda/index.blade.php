...
@section('content')
    ...
    <div class="container mt-1 mb-4">
        <div id="#">
            ...
            <div id="tentangKami">
                <div class="row mt-5">
                    <span class=" judul1 text-uppercase judul2" style="text-align: center; padding: 20px">Tentang
                        Kami</span>

                    <div class="col-md-6  mt-4">
                        <img src="{{ asset('images/main_bola.jpeg') }}" alt="sekolah sepak bola" width="450"
                            class="rounded">
                    </div>
                ...
                <div class="row mt-5 align-items-center">
                    <div class="card col-md-12 p-3" style="border: 2px solid #003459; text-align: center;">
                        ...
                        <span class="mt-4" style="font-size: 16px;">“MENJADI SMK YANG MENGHASILKAN SDM KOMPETEN,
                            BERKARAKTER, DAN IHSAN”</span>
                    </div>
                    ...
                    <div class="card p-3 mt-5" style="border: 2px solid #003459">
                        ...
                        <span class="mt-4 ps-4 ">
                            <ol class="" style="width:900px; padding-left: 10%; font-size: 16px;">
                                ...
                                <li>Membudayakan pengamalan nilai-nilai agama dalam setiap aspek kehidupan seluruh warga
                                    sekolah.</li>
                                <li>Menyelenggarakan pendidikan formal kejuruan untuk menghasilkan lulusan yang berkarakter,
                                    cerdas, inovatif , kreatif, sesuai dengan tuntutan dunia industri dan mampu
                                    berwirausaha.</li>
                                <li>Meningkatkan kualitas tenaga pendidik dan kependidikan sesuai kualifikasi dan kompetensi
                                    standar.</li>
                                <li>Menyelenggarakan Lembaga Sertifikasi Profesi dan Tempat Uji Kompetensi sesuai dengan
                                    bidang kompetensi</li>
            ...
            <di id="hubungiKami">
                <div class="row mt-5">
                    ...
                    <div class="col-md-6 card mt-4 align-items-center" style="width: 500px;">
                        ...
                        <img src="{{ asset('images/stadion.jpg') }}" alt="Stadion" width="450" class="rounded p-2 pt-4">
