...
@section('title', $user->username)
 ...
 {{-- /* --------------- INI GAK DIPAKAI, PAKAI YANG DI FOLDER PROFIL --------------- */ --}}
                ...
                <div class="col-md-4 card">
                    <div class="row p-4 d-flex flex-column align-items-center justify-content-center">
                        <div class="text-center">
                            <img src="{{ asset('storage/' . $user->pemain->user->foto_profil) }}"
                                alt="{{ $user->pemain->nama_pemain }}" class="rounded-circle"
                        ...
                        <div class="mt-4 ">
                            <div class="row">
                                ...
                                <span style="font-weight: 400; font-size: 20px; color:#5b5b5b">@ {{ $user->username }}
                                </span>
                            </div>
                            <div class="row mt-2 ">
                                <span>
                                ...
                                <button class="btn btn-primary mt-4 editBtn" data-bs-toggle="modal"
                                    data-bs-target="#editProfil-modal-{{ $user->pemain->nisn_pemain }}"
                                    idPL={{ $user->pemain->nisn_pemain }}>
                                    Edit Profil
                                </button>

                                <button class="btn btn-primary mt-2 editBtn" style="width: 47%;" data-bs-toggle="modal"
                                    data-bs-target="#editUsername-modal-{{ $user->id_user }}" idUser={{ $user->id_user }}>
                                    Edit Username
                                </button>
                ...
                <div class="col-md-8 card" style="width: 65%">
                    <div class="row p-3">
                        ...
                        <div class="row mt-3">
                            ...
                            <span style="font-size: 17px;"> {{ $user->pemain->tempat_lahir }},
                                {{ $user->pemain->tanggal_lahir }} </span>
                        </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <span style="font-size: 17px; line-height: normal "> {{ $user->pemain->deskripsi_pemain }}
                            </span>
                        </div>
                    ...
                    <div class="modal-body">
                        <form id="edit-pm-form-{{ $user->pemain->nisn_pemain }}">
                            <div class="form-group">
                                ...
                                <input placeholder="example" type="text" class="form-control mb-3" name="nama_pemain"
                                    value="{{ $user->pemain->nama_pemain }}" required />
                                @csrf
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea required name="alamat" id="" class="form-control" rows="3" placeholder="Deskripsi Diri"
                                    style="resize: none">{{ $user->pemain->alamat }}</textarea>

                            </div>

                            <div class="form-group">
                                <label>No. Telepon:</label>
                                <input placeholder="example" type="number" class="form-control mb-3" name="no_telp"
                                    value="{{ $user->pemain->no_telp }}" required />
                            </div>

                            <div class="form-group">
                                <label>Email:</label>
                                <input placeholder="example" type="email" class="form-control mb-3" name="email"
                                    value="{{ $user->pemain->email }}" required />
                            ...
                            <div class="form-group">
                                ...
                                <textarea required name="deskripsi_pemain" id="" class="form-control" rows="5"
                                    placeholder="Deskripsi Diri" style="resize: none">{{ $user->pemain->deskripsi_pemain }}
                    </textarea>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="modal-body">
                        <form id="edit-un-form-{{ $user->id_user }}">
                            <div class="form-group">
                                ...
                                <input placeholder="example" type="text" class="form-control mb-3" name="username"
            ...
            <div class="container mt-4 mb-4">
                <div class="row mt-4 d-flex justify-content-between">
                    <div class="col-md-4 card">
                        <div class="row p-4 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="mt-4 ">
                                <div class="row">
                                    <span class="text-capitalize"
                                        style="font-weight: 800; font-size: 26px; line-height:normal">
                            ...
                            <span style="margin-left: 13px">: {{$user->pelatih->email}}</span> 
                                    ...
                                    <button class="btn btn-primary mt-4 editBtn" data-bs-toggle="modal"
                                        data-bs-target="#editProfil-modal-{{ $user->pelatih->nik_pelatih }}"
                    ...
                    <span style="font-size: 17px;">  0{{$user->pelatih->no_telp}} </span>
                            ...
                            <div class="row mt-3">
                                <span style="font-size: 17px; font-weight: 600;">Tempat, Tanggal Lahir:</span>
                                <span style="font-size: 17px;"> {{ $user->pelatih->tempat_lahir }},
                                    {{ $user->pelatih->tanggal_lahir }} </span>
                            </div>
                            ...
                            <div class="row mt-3">
                                <span style="font-size: 17px; font-weight: 600;">Deskripsi Diri:</span>
                                <span style="font-size: 17px; line-height: normal ">
                                    {{ $user->pelatih->deskripsi_pelatih }} </span>
                            </div>
                            ...
                            <form id="edit-pl-form-{{ $user->pelatih->nik_pelatih }}">
                                <div class="form-group">
                                    ...
                                    <input placeholder="example" type="text" class="form-control mb-3"
                                        name="nama_pelatih" value="{{ $user->pelatih->nama_pelatih }}" required />
                                    @csrf
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Alamat:</label>
                                    <textarea required name="alamat" id="" class="form-control" rows="3" placeholder="Deskripsi Diri"
                                        style="resize: none">{{ $user->pelatih->alamat }}
                        </textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>No. Telepon:</label>
                                    <input placeholder="example" type="number" class="form-control mb-3" name="no_telp"
                                        value="{{ $user->pelatih->no_telp }}" required />
                                </div>

                                <div class="form-group">
                                    <label>Email:</label>
                                    <input placeholder="example" type="email" class="form-control mb-3" name="email"
                                        value="{{ $user->pelatih->email }}" required />
                                </div>

                                <div class="form-group">
                                    <label>Deskripsi Diri:</label>
                                    <textarea required name="deskripsi_pelatih" id="" class="form-control" rows="5"
                                        placeholder="Deskripsi Diri" style="resize: none">{{ $user->pelatih->deskripsi_pelatih }}
                            </textarea>
                                </div>
                            </form>
                        </div>
