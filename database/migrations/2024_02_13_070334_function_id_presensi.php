...
return new class extends Migration{
    private $sfName = 'function_id_presensi';
    /**
     * Run the migrations.
     */
    public function up(): void
    {
        DB::unprepared(
            ...
            BEGIN
                ...
                SELECT MAX(CAST(SUBSTRING(id_presensi, 4) AS SIGNED)) INTO max_id FROM presensi;
                ...
                -- Buat custom ID
                SET custom_id = CONCAT('PSI', LPAD(max_id, 4, '0'));
